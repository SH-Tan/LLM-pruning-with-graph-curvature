...
downstream_summary_csv="${DOWNSTREAM_SUMMARY_CSV:-eval_results/summary_c4_cn_en_compare.csv}"
downstream_suite="${DOWNSTREAM_SUITE:-core}"
downstream_suite_benchmarks="${DOWNSTREAM_SUITE_BENCHMARKS:-mmlu;agieval_cn;xnli_zh;gsm8k}"
downstream_suite_tasks="${DOWNSTREAM_SUITE_TASKS:-mmlu_stem,mmlu_social_sciences;agieval_gaokao_chinese,agieval_logiqa_zh,agieval_jec_qa_kd;xnli_zh;gsm8k}"
downstream_suite_backends="${DOWNSTREAM_SUITE_BACKENDS:-hf;hf;hf;vllm}"
downstream_suite_fewshots="${DOWNSTREAM_SUITE_FEWSHOTS:-5;0;0;8}"
downstream_suite_limits="${DOWNSTREAM_SUITE_LIMITS:-0.25;0.25;0.25;500}"
...
run_eval_for_prune_ops "gate_proj" "$compare_dir_root/gate_up/"

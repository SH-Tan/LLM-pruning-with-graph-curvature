...
generated_calib_data_paths="${GENERATED_CALIB_DATA_PATHS:-${GENERATED_CALIB_DATA_PATH:-downstream_calib_data/generated/mmlu_stem.jsonl downstream_calib_data/generated/truthfulqa_mc1.jsonl downstream_calib_data/generated/winogrande.jsonl}}"

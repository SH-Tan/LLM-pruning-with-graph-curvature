...
run_eval_for_prune_ops "gate_proj" "$compare_dir_root/gate_mmlu/"
run_eval_for_prune_ops "gate_proj up_proj" "$compare_dir_root/gate_up_mmlu/"
run_eval_for_prune_ops "up_proj" "$compare_dir_root/up_mmlu/"
